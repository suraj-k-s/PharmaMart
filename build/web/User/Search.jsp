        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <ul class="list-group">
                        <%                            String selS = "SELECT * from tbl_brand";
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input product_check" value="<%=rsS.getString("brand_id")%>" id="brand"><%=rsS.getString("brand_name")%>
                                </label>
                            </div>
                        </li>
                        <%
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row" id="result">
                        ...
                        <%
                            String selProduct = "select * from tbl_product p inner join tbl_brand sc on sc.brand_id=p.brand_id inner join tbl_category c on c.category_id=p.category_id";
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(".product_check").click(function() {
                    ...
                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxSearch.jsp?action=" + action + "&category=" + category + "&brand=" + brand,
                        success: function(response) {

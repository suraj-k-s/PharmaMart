...
<%
    ...
    if (request.getParameter("action") != "") {
        ...
        String sqlQry = "select * from tbl_product p inner join tbl_brand sc on sc.brand_id=p.brand_id inner join tbl_category c on c.category_id=sc.category_id where true";
        String row = "SELECT count(*) as count from tbl_product p inner join tbl_brand sc on sc.brand_id=p.brand_id inner join tbl_category c on c.category_id=sc.category_id where true";
        ...
        if (!request.getParameter("brand").equals("")) {
            ...
            sqlQry += " AND sc.brand_id IN(" + brand + ")";
            row += " AND sc.brand_id IN(" + brand + ")";
        }
                                ...
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            ...
                                            Brand  : <%=rs.getString("brand_name")%><br>
                                        </p>
                                        <%

                    ...
                    <div class="col-md-6">
                        <div class="contact-form" id="tab">
                            <table>
                                ...
                                <%
                                    int i = 0;
                                    String selQryP = "select * from tbl_product p inner join tbl_brand b on b.brand_id=p.brand_id inner join tbl_category c on c.category_id=p.category_id where shop_id='" + session.getAttribute("sid") + "'";
